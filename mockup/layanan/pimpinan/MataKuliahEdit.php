                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ul" colspan="2"><b>Edit Matakuliah</b></td>
                                </tr>
                                        ...
                                        <tbody>
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md">
                                                    <div class="form-floating">
                                                        <input type="email" class="form-control" id="floatingInput"
                                                            placeholder="name@example.com" value="IF161102">
                                                ...
                                                <div class="col-md">
                                                    <div class="form-floating">
                                                        <input type="email" class="form-control" id="floatingInput"
                                                            placeholder="name@example.com" value="MATEMATIKA DASAR">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md">
                                                    <div class="form-floating">
                                                        <input type="email" class="form-control" id="floatingInput"
                                                            placeholder="name@example.com" value="0.00">
