                                ...
                                <div class="mb-3">
                                    <div class="dt-responsive table-responsive" style="color: #f76700;">
                                        <table class="table row-hover table table-striped">
                                            <thead>
                                                <tr>
                                                    <th rowspan="2" class="tbl">No</th>
                                                    <th rowspan="2" class="tbl">Kode</th>
                                                    <th rowspan="2" class="tbl">Nama Dosen</th>
                                                    <th colspan="2" class="tbl">Hadir</th>
                                                    <th rowspan="2" class="tbl">Program Studi</th>
                                                </tr>
                                                <tr>
                                                    <th class="tbl">Hari</th>
                                                    <th class="tbl">Jam</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td data-label="#">1</td>
                                                    <td data-label="Kode">IF114</td>
                                                    <td data-label="Nama Dosen"><a href="KehadiranDosenDetail.php">DR.
                                                            RIRIN DWI
                                                            AGUSTIN, ST., MT.</a></td>
                                                    <td data-label="Hari">30</td>
                                                    <td data-label="jam">61:32:08</td>
                                                    <td data-label="Prodi"> Teknik Informatika</td>
                                                </tr>
                                                <tr>
                                                    <td data-label="#">2</td>
                                                    <td data-label="Kode">IF014</td>
                                                    <td data-label="Nama Dosen"><a
                                                            href="KehadiranDosenDetail.php">DR.AYI
                                                            PURBASARI, ST., MT.</a></td>
                                                    <td data-label="Hari">30</td>
                                                    <td data-label="jam">61:32:08</td>
                                                    <td data-label="Prodi"> Teknik Informatika</td>
                                                </tr>
