                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="JenisMatKulTambah.php" role="button">Tambah
                                Jenis Matakuliah</a>
                                    ...
                                    <table class="table row-hover table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="ttl" nowrap="true">Singkatan</th>
                                                <th class="ttl" nowrap="true">Jenis matakuliah</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td data-label="#">1</td>
                                                <td data-label="Singkatan"><a href="JenisMatKulEdit.php"><i
                                                            class="ti-pencil"></i> A</a></td>
                                                <td data-label="Jenis Matakuliah">MPK-PENGEMBANGAN KEPRIBADIAN</td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Jenis Matakuliah">MKK-KEILMUAN DAN KETRAMPILAN </td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="#">3</td>
                                                <td data-label="Singkatan"><a href="JenisMatKulEdit.php"><i
                                                            class="ti-pencil"></i> A</a></td>
                                                <td data-label="Jenis Matakuliah">MKB-KEAHLIAN BERKARYA</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                        </tbody>
