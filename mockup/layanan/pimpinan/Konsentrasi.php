                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="KonsentrasiTambah.php" role="button">Tambah
                                Konsentrasi</a>
                                ...
                                <div class="dt-responsive table-responsive" style="color: #f76700;">
                                    <table class="table row-hover table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td data-label="#">1</td>
                                                <td data-label="Kode"><a href="KonsentrasiEdit.php"><i
                                                            class="ti-pencil"></i> CS</a></td>
                                                <td data-label="Nama">Comp Science</td>
                                            ...
                                            <tr>
                                                <td data-label="#">2</td>
                                                <td data-label="Kode"><a href="KonsentrasiEdit.php"><i
                                                            class="ti-pencil"></i> INTI</a></td>
                                                <td data-label="Nama">Informatika Teori</td>
                                                <td data-label="Keterangan"></td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="#">3</td>
                                                <td data-label="Kode"><a href="KonsentrasiEdit.php"><i
                                                            class="ti-pencil"></i> JAR</a></td>
                                                <td data-label="Nama">Jaringan Komputer</td>
                                                <td data-label="Keterangan"></td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                        </tbody>
