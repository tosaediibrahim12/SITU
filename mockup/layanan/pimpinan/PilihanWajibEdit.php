                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ul" colspan="2"><b>Edit Pilihan Wajib</b></td>
                                </tr>
                                ...
                                <div class="dt-responsive table-responsive" style="color: #f76700;">
                                    <table class="table row-hover table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <div class="row g-2">
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="name@example.com" value="A">
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="Semester" value="WAJIB">
                                            ...
                                            <tr>
                                                <td class="ul"><input type="checkbox" name="NA" value="Y"> Kerja
                                                    Praktek?
                                                </td>
                                                <td class="ul"><input type="checkbox" name="NA" value="Y"> Tugas
