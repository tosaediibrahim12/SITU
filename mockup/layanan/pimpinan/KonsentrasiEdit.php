                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ul" colspan="2"><b>Edit Konsentrasi</b></td>
                                </tr>
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="name@example.com" value="CS">
                                                            <label for="floatingInput">Kode Konsentrasi</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="Semester" value="Comp Science">
