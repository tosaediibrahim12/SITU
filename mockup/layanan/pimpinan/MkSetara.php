                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="TampilJadwalPerkuliahan.php" role="button">Cetak</a>
                            <a class="btn btn-primary" href="TampilJadwalPerkuliahan.php" role="button">Tambah
                                Matakuliah</a>
                                    ...
                                    <table class="table row-hover table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="ttl" nowrap="true">Kode MK</th>
                                                <th class="ttl" nowrap="true">Nama</th>
                                                <th class="ttl" nowrap="true">SKS</th>
                                                <th class="ttl" colspan="2" nowrap="true">Ekivalensi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td data-label="#" align="right">2</td>
                                                <td data-label="Kode MK">IF165107</td>
                                                <td data-label="Nama">AGAMA</td>
                                                <td data-label="SKS" align="center">2</td>
                                                <td data-label="Ekivalensi"><a href="MkSetaraForm.php"><i
                                                            class="ti-pencil"></i></a>

                                                </td>
                                                <td data-label="">IT611, IT621, IT622, IT623, IT624&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td data-label="#" align="right">1</td>
                                                <td data-label="Kode MK">IF163737</td>
                                                <td data-label="Nama">ADMINISTRASI INFRASTRUKTUR IT</td>
                                                <td data-label="SKS" align="center">3</td>
                                                <td data-label="Ekivalensi"><a href="#"><i class="ti-pencil"></i></a>
                                                </td>
                                                <td data-label="">IF287&nbsp;</td>
                                            </tr>

                                            <tr>
                                                <td data-label="#" align="right">3</td>
                                                <td data-label="Kode MK">IF161301</td>
                                                <td data-label="Nama">ALGORITMA & PEMROGRAMAN</td>
                                                <td data-label="SKS" align="center">3</td>
                                                <td data-label="Ekivalensi"><a href="#"><i class="ti-pencil"></i></a>
                                                </td>
                                                <td data-label="">IF287&nbsp;</td>
