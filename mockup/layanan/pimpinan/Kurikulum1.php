                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="KurikulumTambah.php" role="button">Tambah
                                Kurikulim</a>
                                    ...
                                    <table class="table row-hover table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="ttl" nowrap="true">Kurikulum</th>
                                                <th class="ttl" nowrap="true">Sesi</th>
                                                <th class="ttl" nowrap="true">Jml/tahun</th>
                                                <th class="ttl" nowrap="true">NA</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td data-label="Kode"><a href="KurikulumEdit.php"><i
                                                            class="ti-pencil"></i></a>
                                                <td data-label="Kurikulum">Kurikulum 2022</td>
                                                <td data-label="Semester">Semester</td>
                                                <td data-label="Jml/tahun">2</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="Kode"><a href="KurikulumEdit.php"><i
                                                            class="ti-pencil"></i></a>
                                                <td data-label="Kurikulum">Kurikulum 2021</td>
                                                <td data-label="Semester">Semester</td>
                                                <td data-label="Jml/tahun">2</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="Kode"><a href="KurikulumEdit.php"><i
                                                            class="ti-pencil"></i></a>
                                                <td data-label="Kurikulum">Kurikulum 2014</td>
                                                <td data-label="Semester">Semester</td>
                                                <td data-label="Jml/tahun">2</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="Kode"><a href="KurikulumEdit.php"><i
                                                            class="ti-pencil"></i></a>
                                                <td data-label="Kurikulum">Kurikulum 2006</td>
                                                <td data-label="Semester">Semester</td>
                                                <td data-label="Jml/tahun">2</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="Kode"><a href="KurikulumEdit.php"><i
                                                            class="ti-pencil"></i></a>
                                                <td data-label="Kurikulum">Kurikulum 2003</td>
                                                <td data-label="Semester">Semester</td>
                                                <td data-label="Jml/tahun">2</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
                                            <tr>
                                                <td data-label="Kode"><a href="#"><i class="ti-pencil"></i></a>
                                                <td data-label="Kurikulum">Kurikulum lama</td>
                                                <td data-label="Semester">Semester</td>
                                                <td data-label="Jml/tahun">2</td>
                                                <td data-label="NA"><i class="ti-book"></i></td>
                                            </tr>
