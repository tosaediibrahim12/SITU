                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ul" colspan="2"><b>Edit Predikat</b></td>
                                </tr>
                                ...
                                <div class="dt-responsive table-responsive" style="color: #f76700;">
                                    <table class="table row-hover table table-striped">
                                        ...
                                        <tbody>
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="name@example.com" value="C">
                                                            <label for="floatingInput">Predikat</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="floatingSelectGrid">Program Studi</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="name@example.com" value="3.51">
                                                            <label for="floatingInput">Mulai IPK</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="name@example.com" value="4.00">
                                                            <label for="floatingInput">Mulai IPK</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="floatingInput"
                                                                placeholder="name@example.com" value="Dengan Pujian">
                                            ...
                                            <tr>
                                                <td class="ul"><input type="checkbox" name="NA" value="Y"> Tidak
                                                    aktif?(NA)
                                                </td>
                                            </tr>
                                            <tr>
