                            ...
                            <div class="col-md-8">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">Pilihan</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary"> <a class="btn btn-success"
                                                    role="button" href="PaketKRS.php"><i class="ti-clipboard"></i>
                                                    Paket KRS </a>
                                                <a class="btn btn-success" role="button" href="#"><i
                                                ...
                                                <table class="table row-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td data-label="Kode MK">IF161201</td>
                                                            <td data-label="Matakuliah">Daspro</td>
                                                            <td data-label="status">Diterima</td>
                                                            <td data-label="Kelas">-</td>
                                                            <td data-label="SKS">-</td>
                                                            <td data-label="Mundur"><a href=""><i
                                                                        class="ti-trash"></i></a></td>
                                                            <td data-label="Waktu Input">2020-01-10 16:56:35</td>
                                                        </tr>
                                                        <tr>
                                                            <td data-label="No">2</td>
                                                            <td data-label="Kode MK">IF161201</td>
                                                            <td data-label="Matakuliah">INPA</td>
                                                            <td data-label="status">Diterima</td>
                                                            <td data-label="Kelas">-</td>
                                                            <td data-label="SKS">-</td>
                                                            <td data-label="Mundur"><a href=""><i
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-label="Kode MK">IF161201</td>
                                                            <td data-label="Matakuliah">Tekom</td>
                                                            <td data-label="status">Diterima</td>
                                                            <td data-label="Kelas">-</td>
                                                            <td data-label="SKS">-</td>
                                                            <td data-label="Mundur"><a href=""><i
                                                        ...
                                                        <tr class="table-active">
                                                            <td data-label="No" colspan="7">Total SKS</td>
                                                            <td data-label="Kode MK">18</td>
                                        ...
                                        <table class="table row-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td data-label="Kelas">-</td>
                                                    <td data-label="SKS">-</td>
                                                    <td data-label="Mundur"><a href=""><i class="ti-trash"></i></a>
                                                    </td>
                                                    <td data-label="Waktu Input">2020-01-10 16:56:35</td>
                                                </tr>
