                                                ...
                                                <table
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="ttl" nowrap="true">Cetak<br>Individual</th>
                                                            <th class="ttl" nowrap="true"><input type="submit"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-label="#">1</td>
                                                            <td data-label="Kode MK">IF306</td>
                                                            ...
                                                            <td data-label="">
                                                                <a href="?mnux=jadwal.pemberitahuan.cetak&amp;Lulus=&amp;dosenid[]=IF306&amp;tahun=20182&amp;prodi=304&amp;prid=REG&amp;noSurat=&amp;tglSurat="
                                                                    target="_blank">Cetak</a>
                                                            </td>
                                                            <td data-label=""><input type="checkbox" name="dosenid[]"
                                                                    value="IF306" checked=""></td>

                                                            <td class="ul">
                                                                <input type="checkbox" name="hp_dsn[]"
                                                                    value="6281285279747" checked="">
                                                                <a
                                                                    href="?mnux=jadwal.pemberitahuan&amp;gos=WADsn&amp;hp_dsn[]=628112030065">WA
                                                                    ke Dosen</a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td data-label="#">1</td>
                                                            <td data-label="Kode MK">IF3012</td>
